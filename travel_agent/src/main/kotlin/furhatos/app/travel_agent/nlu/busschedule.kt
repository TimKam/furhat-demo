...
fun getSchedule(startPlace: String, destination: String, startDate: String, startTime: String): BusSchedule {
    val client = OkHttpClient()
    ...
    var bustrip = BusSchedule()
    bustrip.trip = "ta buss 8 till vasaplan"
    return bustrip
